  ...
  return (
    <div className='p-4'>
      <div className="flex justify-between items-center">
        ...
        <Link to='/books/create' className='text-sky-500 text-4xl'>
            ...
            <tbody>
              {books.map((book, index) => (
                  <tr key={book._id} className='h-8'>
                    ...
                    <td className='border border-slate-700 rounded-md text-center'>{ book.description }</td>
                    <td className='border border-slate-700 rounded-md text-center'>{ book.publishedYear }</td>
                    <td className='border border-slate-700 rounded-md text-center'>{ book.price }</td>
